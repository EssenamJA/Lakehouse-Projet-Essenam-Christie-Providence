#!C:\Users\essen\OneDrive\Documents\MASTER DATA ANNEE 2\DATALAKE\PROJET WINTER SPORT\Lakehouse-Projet-Essenam-Christie-Providence\.venv\Scripts\python.exe
# -*- coding: utf-8 -*-
#!/usr/bin/env python
